...
public final class Intents {
  ...
  public static final class Encode {
    ...
    /**
     * Normally the contents of the barcode are displayed to the user in a UnderlineTextView. Setting this
     * boolean to false will hide that UnderlineTextView, showing only the encode barcode.
     */
